...
class Jaula {
    ...
    public function crear($nombre, $tamano, $numCamino) {
        try {
            $query = "INSERT INTO LasJaulas (nombre, tamano, numCamino) 
    ...
    public function eliminar($numJaula) {
        try {
            ...
            $query = "SELECT COUNT(*) FROM LosAnimales WHERE numJaula = :numJaula";
            $stmt = $this->conn->prepare($query);
            $stmt->execute(['numJaula' => $numJaula]);
            ...
            // Eliminar jaula
            $query = "DELETE FROM LasJaulas WHERE numJaula = :numJaula";
            $stmt = $this->conn->prepare($query);
            $stmt->execute(['numJaula' => $numJaula]);
